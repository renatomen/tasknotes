...
- **Weight**: Numeric value preserved for potential future use.
...
>
> The weight field does not affect Bases sorting, but is retained in settings for potential future functionality.
