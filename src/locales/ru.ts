...
export const ruConfig: NLPLanguageConfig = {
    ...
    recurrence: {
        ...
        pluralWeekdays: {
            monday: ['понедельник', 'в понедельник', 'по понедельникам'],
            tuesday: ['вторник', 'во вторник', 'по вторникам'],
            wednesday: ['среда', 'в среду', 'по средам'],
            thursday: ['четверг', 'в четверг', 'по четвергам'],
            friday: ['пятница', 'в пятницу', 'по пятницам'],
            saturday: ['суббота', 'в субботу', 'по субботам'],
            sunday: ['воскресенье', 'в воскресенье', 'по воскресеньям']
        },
