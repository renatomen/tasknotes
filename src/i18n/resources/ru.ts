	...
	settings: {
		...
		features: {
			...
			timeblocking: {
				...
				description: "Настройте функциональность временных блоков для легкого планирования в ежедневных заметках. В расширенном представлении календаря удерживайте Shift + клик и перетащите для создания временных блоков.",
