		...
		features: {
			...
			instantConvert: {
				...
				folder: {
					...
					description:
						"Папка, в которой будут создаваться задачи, преобразованные из флажков. Используйте {{currentNotePath}} для относительного пути к текущей заметке, {{currentNoteTitle}} для заголовка текущей заметки",
				},
			},
			nlp: {
